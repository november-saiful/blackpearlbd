...
export const CASCADER_SCROLL_CLASS =
  "size-full min-h-0 [&_*]:data-[slot=scroll-area-viewport]:h-full [&_*]:data-[slot=scroll-area-viewport]:overscroll-contain [&_*]:data-[slot=scroll-area-viewport]:scroll-py-[max(var(--cascader-list-pad,4px),4px)]"

/** The rows' box; `data-[empty]:p-0` keeps an empty state from double inset. */
export const CASCADER_ROWS_CLASS = "p-[var(--cascader-list-pad,4px)] data-[empty]:p-0"
