...
const PANEL_GUTTER_CLASS = "px-[var(--filter-panel-pad)]"

const PANEL_CLASS = "flex w-full min-w-0 flex-col gap-2 py-[var(--filter-panel-pad)]"
...
const FOOTER_DROP_CLASS = cn(
  ...
  "data-[drop-into]:after:start-[var(--filter-panel-pad)]",
